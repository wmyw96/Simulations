...
def experiment_1_6_2_mu(x: np.ndarray) -> np.ndarray:
    """Return the outcome regression used in experiment 1.6.2."""
    return 0.25 * np.sin(2.0 * np.pi * x[:, [0]])


def experiment_1_6_2_pi_1(x: np.ndarray) -> np.ndarray:
    """Return the first treatment regression in experiment 1.6.2."""
    return np.sin(2.0 * np.pi * x[:, [0]])


def experiment_1_6_2_pi_2(x: np.ndarray) -> np.ndarray:
    """Return the second treatment regression in experiment 1.6.2."""
    return 2.0 * np.sin(2.0 * np.pi * x[:, [0]])


def experiment_1_6_2_pi_3(x: np.ndarray) -> np.ndarray:
    """Return the third treatment regression in experiment 1.6.2."""
    return 3.0 * np.sin(2.0 * np.pi * x[:, [0]])


def experiment_1_6_3_mu(x: np.ndarray) -> np.ndarray:
    """Return the outcome regression used in experiment 1.6.3."""
    x1 = x[:, [0]]
    x2 = x[:, [1]]
    return np.sin(2.0 * x1) + 0.25 * np.sin(6.0 * x2)


def experiment_1_6_3_pi_1(x: np.ndarray) -> np.ndarray:
    """Return the first treatment regression in experiment 1.6.3."""
    x1 = x[:, [0]]
    x2 = x[:, [1]]
    return np.sin(2.0 * x1) + np.sin(6.0 * x2)


def experiment_1_6_3_pi_2(x: np.ndarray) -> np.ndarray:
    """Return the second treatment regression in experiment 1.6.3."""
    x1 = x[:, [0]]
    x2 = x[:, [1]]
    return np.sin(2.0 * x1) + 2.0 * np.sin(6.0 * x2)


def experiment_1_6_3_pi_3(x: np.ndarray) -> np.ndarray:
    """Return the third treatment regression in experiment 1.6.3."""
    x1 = x[:, [0]]
    x2 = x[:, [1]]
    return np.sin(2.0 * x1) + 3.0 * np.sin(6.0 * x2)


def experiment_1_6_4_mu(x: np.ndarray) -> np.ndarray:
    """Return the same-coordinate outcome regression used in experiment 1.6.4."""
    x1 = x[:, [0]]
    return np.sin(2.0 * x1) + 0.25 * np.sin(6.0 * x1)


def experiment_1_6_4_pi_1(x: np.ndarray) -> np.ndarray:
    """Return the first same-coordinate treatment regression in experiment 1.6.4."""
    x1 = x[:, [0]]
    return np.sin(2.0 * x1) + np.sin(6.0 * x1)


def experiment_1_6_4_pi_2(x: np.ndarray) -> np.ndarray:
    """Return the second same-coordinate treatment regression in experiment 1.6.4."""
    x1 = x[:, [0]]
    return np.sin(2.0 * x1) + 2.0 * np.sin(6.0 * x1)


def experiment_1_6_4_pi_3(x: np.ndarray) -> np.ndarray:
    """Return the third same-coordinate treatment regression in experiment 1.6.4."""
    x1 = x[:, [0]]
    return np.sin(2.0 * x1) + 3.0 * np.sin(6.0 * x1)


def experiment_1_6_5_mu(x: np.ndarray) -> np.ndarray:
    """Return the rough-only outcome regression used in experiment 1.6.5."""
    x1 = x[:, [0]]
    return 0.25 * np.sin(6.0 * x1)


def experiment_1_6_5_pi_1(x: np.ndarray) -> np.ndarray:
    """Return the first rough-only treatment regression in experiment 1.6.5."""
    x1 = x[:, [0]]
    return np.sin(6.0 * x1)


def experiment_1_6_5_pi_2(x: np.ndarray) -> np.ndarray:
    """Return the second rough-only treatment regression in experiment 1.6.5."""
    x1 = x[:, [0]]
    return 2.0 * np.sin(6.0 * x1)


def experiment_1_6_5_pi_3(x: np.ndarray) -> np.ndarray:
    """Return the third rough-only treatment regression in experiment 1.6.5."""
    x1 = x[:, [0]]
...
def _experiment_1_6_7_eta(x: np.ndarray) -> np.ndarray:
    x1 = x[:, [0]]
    x2 = x[:, [1]]
    return np.sin(x1) + 0.25 * np.sin(5.0 * x2) + 0.05 * np.sin(20.0 * x2)


def experiment_1_6_7_mu(x: np.ndarray) -> np.ndarray:
    """Return the eta outcome regression used in experiment 1.6.7."""
    return _experiment_1_6_7_eta(x)


def experiment_1_6_7_pi_1(x: np.ndarray) -> np.ndarray:
    """Return the treatment regression with k = 0.5 in experiment 1.6.7."""
    return 2.0 * _experiment_1_6_7_eta(x)


def experiment_1_6_7_pi_2(x: np.ndarray) -> np.ndarray:
    """Return the treatment regression with k = 1 in experiment 1.6.7."""
    return 4.0 * _experiment_1_6_7_eta(x)


def experiment_1_6_7_pi_3(x: np.ndarray) -> np.ndarray:
    """Return the treatment regression with k = 2 in experiment 1.6.7."""
    return 8.0 * _experiment_1_6_7_eta(x)


def _experiment_1_6_8_eta(x: np.ndarray) -> np.ndarray:
    x2 = x[:, [1]]
    return np.sin(x2) + 0.25 * np.sin(5.0 * x2) + 0.05 * np.sin(20.0 * x2)


def _experiment_1_6_8_residual(x: np.ndarray) -> np.ndarray:
    x2 = x[:, [1]]
    return _experiment_1_6_8_eta(x) - np.sin(x2)


def experiment_1_6_8_mu(x: np.ndarray) -> np.ndarray:
    """Return the eta outcome regression used in experiment 1.6.8."""
    return _experiment_1_6_8_eta(x)


def experiment_1_6_8_pi_1(x: np.ndarray) -> np.ndarray:
    """Return the treatment regression with k = 1 in experiment 1.6.8."""
    return 4.0 * _experiment_1_6_8_residual(x)


def experiment_1_6_8_pi_2(x: np.ndarray) -> np.ndarray:
    """Return the treatment regression with k = 2 in experiment 1.6.8."""
    return 8.0 * _experiment_1_6_8_residual(x)


def experiment_1_6_8_pi_3(x: np.ndarray) -> np.ndarray:
    """Return the treatment regression with k = 3 in experiment 1.6.8."""
    return 12.0 * _experiment_1_6_8_residual(x)


def _experiment_1_6_9_eta(x: np.ndarray) -> np.ndarray:
    x2 = x[:, [1]]
    return np.sin(x2) + 0.25 * np.sin(5.0 * x2) + 0.05 * np.sin(20.0 * x2)


def _experiment_1_6_9_residual(x: np.ndarray) -> np.ndarray:
    x2 = x[:, [1]]
    return _experiment_1_6_9_eta(x) - np.sin(x2)


def experiment_1_6_9_mu(x: np.ndarray) -> np.ndarray:
    """Return the eta outcome regression used in experiment 1.6.9."""
    return _experiment_1_6_9_eta(x)


def experiment_1_6_9_pi_1(x: np.ndarray) -> np.ndarray:
    """Return the treatment regression with k = 1 in experiment 1.6.9."""
    x2 = x[:, [1]]
    return np.sin(x2) + 4.0 * _experiment_1_6_9_residual(x)


def experiment_1_6_9_pi_2(x: np.ndarray) -> np.ndarray:
    """Return the treatment regression with k = 2 in experiment 1.6.9."""
    x2 = x[:, [1]]
    return np.sin(x2) + 8.0 * _experiment_1_6_9_residual(x)


def experiment_1_6_9_pi_3(x: np.ndarray) -> np.ndarray:
    """Return the treatment regression with k = 3 in experiment 1.6.9."""
    x2 = x[:, [1]]
    return np.sin(x2) + 12.0 * _experiment_1_6_9_residual(x)


def _experiment_1_6_11_eta(x: np.ndarray) -> np.ndarray:
    x1 = x[:, [0]]
    x2 = x[:, [1]]
    x3_to_x10 = x[:, 2:10]
    rough_tail = 0.005 * np.sum(np.sin(30.0 * x3_to_x10), axis=1, keepdims=True)
    return np.sin(x1) + 0.25 * np.sin(4.0 * x2) + 0.05 * np.sin(11.0 * x2) + rough_tail


def _experiment_1_6_11_residual(x: np.ndarray) -> np.ndarray:
    x1 = x[:, [0]]
    return _experiment_1_6_11_eta(x) - np.sin(x1)


def experiment_1_6_11_mu(x: np.ndarray) -> np.ndarray:
    """Return the ten-dimensional eta outcome regression used in experiment 1.6.11."""
    return _experiment_1_6_11_eta(x)


def experiment_1_6_11_pi_1(x: np.ndarray) -> np.ndarray:
    """Return the treatment regression with k = 1 in experiment 1.6.11."""
    return 4.0 * _experiment_1_6_11_residual(x)


def experiment_1_6_11_pi_2(x: np.ndarray) -> np.ndarray:
    """Return the treatment regression with k = 2 in experiment 1.6.11."""
    return 8.0 * _experiment_1_6_11_residual(x)


def experiment_1_6_11_pi_3(x: np.ndarray) -> np.ndarray:
    """Return the treatment regression with k = 3 in experiment 1.6.11."""
...
def _experiment_1_6_13_eta(x: np.ndarray) -> np.ndarray:
    x2 = x[:, [1]]
    return np.sin(x2) + 0.25 * np.sin(5.0 * x2) + 0.05 * np.sin(20.0 * x2)


def experiment_1_6_13_mu(x: np.ndarray) -> np.ndarray:
    """Return the two-dimensional eta outcome regression used in experiment 1.6.13."""
    return _experiment_1_6_13_eta(x)


def experiment_1_6_13_pi_1(x: np.ndarray) -> np.ndarray:
    """Return the treatment regression with k = 1 in experiment 1.6.13."""
    x2 = x[:, [1]]
    return np.sin(x2) + np.sin(5.0 * x2) + 0.05 * np.sin(20.0 * x2)


def experiment_1_6_13_pi_2(x: np.ndarray) -> np.ndarray:
    """Return the treatment regression with k = 2 in experiment 1.6.13."""
    x2 = x[:, [1]]
    return np.sin(x2) + 2.0 * np.sin(5.0 * x2) + 0.05 * np.sin(20.0 * x2)


def experiment_1_6_13_pi_3(x: np.ndarray) -> np.ndarray:
    """Return the treatment regression with k = 3 in experiment 1.6.13."""
    x2 = x[:, [1]]
    return np.sin(x2) + 3.0 * np.sin(5.0 * x2) + 0.05 * np.sin(20.0 * x2)


def experiment_1_6_14_mu(x: np.ndarray) -> np.ndarray:
    """Return the three-dimensional outcome regression used in experiment 1.6.14."""
    x1 = x[:, [0]]
    x2 = x[:, [1]]
    x3 = x[:, [2]]
    return np.cos(x1) + 0.25 * np.sin(6.0 * x2) + 0.05 * np.sin(19.0 * x3)


def experiment_1_6_14_pi_1(x: np.ndarray) -> np.ndarray:
    """Return the treatment regression with k = 1 in experiment 1.6.14."""
    x1 = x[:, [0]]
    x2 = x[:, [1]]
    x3 = x[:, [2]]
    return np.cos(x1) + 0.5 * np.sin(6.0 * x2) + 0.05 * np.sin(19.0 * x3)


def experiment_1_6_14_pi_2(x: np.ndarray) -> np.ndarray:
    """Return the treatment regression with k = 2 in experiment 1.6.14."""
    x1 = x[:, [0]]
    x2 = x[:, [1]]
    x3 = x[:, [2]]
    return np.cos(x1) + np.sin(6.0 * x2) + 0.05 * np.sin(19.0 * x3)


def experiment_1_6_14_pi_4(x: np.ndarray) -> np.ndarray:
    """Return the treatment regression with k = 4 in experiment 1.6.14."""
    x1 = x[:, [0]]
    x2 = x[:, [1]]
    x3 = x[:, [2]]
    return np.cos(x1) + 2.0 * np.sin(6.0 * x2) + 0.05 * np.sin(19.0 * x3)
...
PLM_172_NUM_TERMS = 10
PLM_172_DIMENSION = 5
_PLM_172_Q = _PLM_171_Q.copy()


def _plm_172_project_onto_q(x: np.ndarray) -> np.ndarray:
    """Project x onto the shared unit vector q used in experiment 1.7.2."""
    x_array = np.asarray(x, dtype=float)
    if x_array.ndim != 2 or x_array.shape[1] != PLM_172_DIMENSION:
        raise ValueError(f"experiment_1_7_2 expects x to have shape (n, {PLM_172_DIMENSION}).")
    return x_array @ _PLM_172_Q


def _plm_172_g_r_from_projection(z: np.ndarray, r: float) -> np.ndarray:
    """Evaluate the fixed-coefficient Fourier family g_r on a one-dimensional projection."""
    if r <= 0:
        raise ValueError("r must be positive.")
    z_array = np.asarray(z, dtype=float).reshape(-1)
    k = np.arange(1, PLM_172_NUM_TERMS + 1, dtype=float)
    weights = k ** (-1.0 / float(r))
    denominator = float(np.sqrt(np.sum(2.0 * (weights**2))))
    if denominator <= 0:
        raise ZeroDivisionError("The experiment_1_7_2 normalization denominator must be positive.")
    phases = np.pi * np.outer(z_array, k)
    numerator = np.sin(phases) * weights[None, :] + np.cos(phases) * weights[None, :]
    return np.sum(numerator, axis=1, keepdims=True) / denominator


def experiment_1_7_2_mu(x: np.ndarray) -> np.ndarray:
    """Return mu(x) = g_1(q^T x) for PLM experiment 1.7.2."""
    return _plm_172_g_r_from_projection(_plm_172_project_onto_q(x), r=1.0)


def experiment_1_7_2_pi_1(x: np.ndarray) -> np.ndarray:
    """Return pi_1(x) = g_1(q^T x) for PLM experiment 1.7.2."""
    return _plm_172_g_r_from_projection(_plm_172_project_onto_q(x), r=1.0)


def experiment_1_7_2_pi_2(x: np.ndarray) -> np.ndarray:
    """Return pi_2(x) = g_2(q^T x) for PLM experiment 1.7.2."""
    return _plm_172_g_r_from_projection(_plm_172_project_onto_q(x), r=2.0)


def experiment_1_7_2_pi_4(x: np.ndarray) -> np.ndarray:
    """Return pi_4(x) = g_4(q^T x) for PLM experiment 1.7.2."""
    return _plm_172_g_r_from_projection(_plm_172_project_onto_q(x), r=4.0)


def experiment_1_7_2_pi_8(x: np.ndarray) -> np.ndarray:
    """Return pi_8(x) = g_8(q^T x) for PLM experiment 1.7.2."""
    return _plm_172_g_r_from_projection(_plm_172_project_onto_q(x), r=8.0)


PLM_173_DIMENSION = 3


def _plm_173_first_coordinate(x: np.ndarray) -> np.ndarray:
    """Return the first coordinate used in experiment 1.7.3."""
    x_array = np.asarray(x, dtype=float)
    if x_array.ndim != 2 or x_array.shape[1] != PLM_173_DIMENSION:
        raise ValueError(f"experiment_1_7_3 expects x to have shape (n, {PLM_173_DIMENSION}).")
    return x_array[:, 0]


def experiment_1_7_3_mu(x: np.ndarray) -> np.ndarray:
    """Return mu(x) = g_1(x_1) for PLM experiment 1.7.3."""
    return _plm_172_g_r_from_projection(_plm_173_first_coordinate(x), r=1.0)


def experiment_1_7_3_pi_1(x: np.ndarray) -> np.ndarray:
    """Return pi_1(x) = g_1(x_1) for PLM experiment 1.7.3."""
    return _plm_172_g_r_from_projection(_plm_173_first_coordinate(x), r=1.0)


def experiment_1_7_3_pi_2(x: np.ndarray) -> np.ndarray:
    """Return pi_2(x) = g_2(x_1) for PLM experiment 1.7.3."""
    return _plm_172_g_r_from_projection(_plm_173_first_coordinate(x), r=2.0)


def experiment_1_7_3_pi_4(x: np.ndarray) -> np.ndarray:
    """Return pi_4(x) = g_4(x_1) for PLM experiment 1.7.3."""
    return _plm_172_g_r_from_projection(_plm_173_first_coordinate(x), r=4.0)


def experiment_1_7_3_pi_8(x: np.ndarray) -> np.ndarray:
    """Return pi_8(x) = g_8(x_1) for PLM experiment 1.7.3."""
    return _plm_172_g_r_from_projection(_plm_173_first_coordinate(x), r=8.0)


PLM_174_DIMENSION = 2


def _plm_174_first_coordinate(x: np.ndarray) -> np.ndarray:
    """Return the first coordinate used in experiment 1.7.4."""
    x_array = np.asarray(x, dtype=float)
    if x_array.ndim != 2 or x_array.shape[1] != PLM_174_DIMENSION:
        raise ValueError(f"experiment_1_7_4 expects x to have shape (n, {PLM_174_DIMENSION}).")
    return x_array[:, 0]


def _plm_174_g_r_from_coordinate(z: np.ndarray, r: float) -> np.ndarray:
    """Evaluate the fixed-coefficient Fourier family with b_k = (-1)^k on a coordinate."""
    if r <= 0:
        raise ValueError("r must be positive.")
    z_array = np.asarray(z, dtype=float).reshape(-1)
    k = np.arange(1, PLM_172_NUM_TERMS + 1, dtype=float)
    ...
    b_coeffs = (-1.0) ** k
    denominator = float(np.sqrt(np.sum((a_coeffs**2 + b_coeffs**2) * (weights**2))))
    if denominator <= 0:
        raise ZeroDivisionError("The experiment_1_7_4 normalization denominator must be positive.")
    phases = np.pi * np.outer(z_array, k)
    numerator = (
...
def experiment_1_7_4_mu(x: np.ndarray) -> np.ndarray:
    """Return mu(x) = g_1(x_1) for PLM experiment 1.7.4 with b_k = (-1)^k."""
    return _plm_174_g_r_from_coordinate(_plm_174_first_coordinate(x), r=1.0)


def experiment_1_7_4_pi_1(x: np.ndarray) -> np.ndarray:
    """Return pi_1(x) = g_1(x_1) for PLM experiment 1.7.4 with b_k = (-1)^k."""
    return _plm_174_g_r_from_coordinate(_plm_174_first_coordinate(x), r=1.0)


def experiment_1_7_4_pi_2(x: np.ndarray) -> np.ndarray:
    """Return pi_2(x) = g_2(x_1) for PLM experiment 1.7.4 with b_k = (-1)^k."""
    return _plm_174_g_r_from_coordinate(_plm_174_first_coordinate(x), r=2.0)


def experiment_1_7_4_pi_4(x: np.ndarray) -> np.ndarray:
    """Return pi_4(x) = g_4(x_1) for PLM experiment 1.7.4 with b_k = (-1)^k."""
    return _plm_174_g_r_from_coordinate(_plm_174_first_coordinate(x), r=4.0)


def experiment_1_7_4_pi_8(x: np.ndarray) -> np.ndarray:
    """Return pi_8(x) = g_8(x_1) for PLM experiment 1.7.4 with b_k = (-1)^k."""
...
PLM_179_DIMENSION = 5
_PLM_179_W = np.full(PLM_179_DIMENSION, 1.0 / math.sqrt(PLM_179_DIMENSION))
...
def experiment_1_7_8_mu(x: np.ndarray) -> np.ndarray:
    """Return mu(x) = f_0.6(w^T x) for PLM experiment 1.7.8."""
    return _plm_175_f_r_from_projection(_plm_175_project_onto_w(x), r=0.6)


def _plm_179_project_onto_w(x: np.ndarray) -> np.ndarray:
    """Project x onto the fixed direction w used in experiment 1.7.9."""
    x_array = np.asarray(x, dtype=float)
    if x_array.ndim != 2 or x_array.shape[1] != PLM_179_DIMENSION:
        raise ValueError(f"experiment_1_7_9 expects x to have shape (n, {PLM_179_DIMENSION}).")
    return x_array @ _PLM_179_W


def experiment_1_7_9_mu(x: np.ndarray) -> np.ndarray:
    """Return mu(x) = f_0.6(w^T x) for PLM experiment 1.7.9."""
    return _plm_175_f_r_from_projection(_plm_179_project_onto_w(x), r=0.6)


def experiment_1_7_9_pi_1(x: np.ndarray) -> np.ndarray:
    """Return pi_1(x) = f_1(w^T x) for PLM experiment 1.7.9."""
    return _plm_175_f_r_from_projection(_plm_179_project_onto_w(x), r=1.0)


def experiment_1_7_9_pi_2(x: np.ndarray) -> np.ndarray:
    """Return pi_2(x) = f_2(w^T x) for PLM experiment 1.7.9."""
    return _plm_175_f_r_from_projection(_plm_179_project_onto_w(x), r=2.0)


def experiment_1_7_9_pi_4(x: np.ndarray) -> np.ndarray:
    """Return pi_4(x) = f_4(w^T x) for PLM experiment 1.7.9."""
    return _plm_175_f_r_from_projection(_plm_179_project_onto_w(x), r=4.0)


def experiment_1_7_9_pi_8(x: np.ndarray) -> np.ndarray:
    """Return pi_8(x) = f_8(w^T x) for PLM experiment 1.7.9."""
    return _plm_175_f_r_from_projection(_plm_179_project_onto_w(x), r=8.0)
...
FUNCTION_REGISTRY = {
    ...
    "experiment_1_6_2_mu": experiment_1_6_2_mu,
    "experiment_1_6_2_pi_1": experiment_1_6_2_pi_1,
    "experiment_1_6_2_pi_2": experiment_1_6_2_pi_2,
    "experiment_1_6_2_pi_3": experiment_1_6_2_pi_3,
    "experiment_1_6_3_mu": experiment_1_6_3_mu,
    "experiment_1_6_3_pi_1": experiment_1_6_3_pi_1,
    "experiment_1_6_3_pi_2": experiment_1_6_3_pi_2,
    "experiment_1_6_3_pi_3": experiment_1_6_3_pi_3,
    "experiment_1_6_4_mu": experiment_1_6_4_mu,
    "experiment_1_6_4_pi_1": experiment_1_6_4_pi_1,
    "experiment_1_6_4_pi_2": experiment_1_6_4_pi_2,
    "experiment_1_6_4_pi_3": experiment_1_6_4_pi_3,
    "experiment_1_6_5_mu": experiment_1_6_5_mu,
    ...
    "experiment_1_6_7_mu": experiment_1_6_7_mu,
    "experiment_1_6_7_pi_1": experiment_1_6_7_pi_1,
    "experiment_1_6_7_pi_2": experiment_1_6_7_pi_2,
    "experiment_1_6_7_pi_3": experiment_1_6_7_pi_3,
    "experiment_1_6_8_mu": experiment_1_6_8_mu,
    "experiment_1_6_8_pi_1": experiment_1_6_8_pi_1,
    "experiment_1_6_8_pi_2": experiment_1_6_8_pi_2,
    "experiment_1_6_8_pi_3": experiment_1_6_8_pi_3,
    "experiment_1_6_9_mu": experiment_1_6_9_mu,
    "experiment_1_6_9_pi_1": experiment_1_6_9_pi_1,
    "experiment_1_6_9_pi_2": experiment_1_6_9_pi_2,
    "experiment_1_6_9_pi_3": experiment_1_6_9_pi_3,
    "experiment_1_6_11_mu": experiment_1_6_11_mu,
    ...
    "experiment_1_6_13_mu": experiment_1_6_13_mu,
    "experiment_1_6_13_pi_1": experiment_1_6_13_pi_1,
    "experiment_1_6_13_pi_2": experiment_1_6_13_pi_2,
    "experiment_1_6_13_pi_3": experiment_1_6_13_pi_3,
    "experiment_1_6_14_mu": experiment_1_6_14_mu,
    "experiment_1_6_14_pi_1": experiment_1_6_14_pi_1,
    "experiment_1_6_14_pi_2": experiment_1_6_14_pi_2,
    "experiment_1_6_14_pi_4": experiment_1_6_14_pi_4,
    ...
    "experiment_1_7_2_mu": experiment_1_7_2_mu,
    "experiment_1_7_2_pi_1": experiment_1_7_2_pi_1,
    "experiment_1_7_2_pi_2": experiment_1_7_2_pi_2,
    "experiment_1_7_2_pi_4": experiment_1_7_2_pi_4,
    "experiment_1_7_2_pi_8": experiment_1_7_2_pi_8,
    "experiment_1_7_3_mu": experiment_1_7_3_mu,
    "experiment_1_7_3_pi_1": experiment_1_7_3_pi_1,
    "experiment_1_7_3_pi_2": experiment_1_7_3_pi_2,
    "experiment_1_7_3_pi_4": experiment_1_7_3_pi_4,
    "experiment_1_7_3_pi_8": experiment_1_7_3_pi_8,
    "experiment_1_7_4_mu": experiment_1_7_4_mu,
    "experiment_1_7_4_pi_1": experiment_1_7_4_pi_1,
    ...
    "experiment_1_7_8_mu": experiment_1_7_8_mu,
    "experiment_1_7_9_mu": experiment_1_7_9_mu,
    ...
    "experiment_1_7_9_pi_1": experiment_1_7_9_pi_1,
    "experiment_1_7_9_pi_2": experiment_1_7_9_pi_2,
    "experiment_1_7_9_pi_4": experiment_1_7_9_pi_4,
    "experiment_1_7_9_pi_8": experiment_1_7_9_pi_8,
}
...
FUNCTION_LABELS = {
    ...
    "experiment_1_6_2_mu": r"$0.25\sin(2\pi x_1)$",
    "experiment_1_6_2_pi_1": r"$\sin(2\pi x_1)$",
    "experiment_1_6_2_pi_2": r"$2\sin(2\pi x_1)$",
    "experiment_1_6_2_pi_3": r"$3\sin(2\pi x_1)$",
    "experiment_1_6_3_mu": r"$\sin(2x_1)+0.25\sin(6x_2)$",
    "experiment_1_6_3_pi_1": r"$\sin(2x_1)+\sin(6x_2)$",
    "experiment_1_6_3_pi_2": r"$\sin(2x_1)+2\sin(6x_2)$",
    "experiment_1_6_3_pi_3": r"$\sin(2x_1)+3\sin(6x_2)$",
    "experiment_1_6_4_mu": r"$\sin(2x_1)+0.25\sin(6x_1)$",
    "experiment_1_6_4_pi_1": r"$\sin(2x_1)+\sin(6x_1)$",
    "experiment_1_6_4_pi_2": r"$\sin(2x_1)+2\sin(6x_1)$",
    "experiment_1_6_4_pi_3": r"$\sin(2x_1)+3\sin(6x_1)$",
    "experiment_1_6_5_mu": r"$0.25\sin(6x_1)$",
    ...
    "experiment_1_6_7_mu": r"$\eta(x)$",
    "experiment_1_6_7_pi_1": r"$2\eta(x)$",
    "experiment_1_6_7_pi_2": r"$4\eta(x)$",
    "experiment_1_6_7_pi_3": r"$8\eta(x)$",
    "experiment_1_6_8_mu": r"$\eta(x)$",
    "experiment_1_6_8_pi_1": r"$4(\eta(x)-\sin(x_2))$",
    "experiment_1_6_8_pi_2": r"$8(\eta(x)-\sin(x_2))$",
    "experiment_1_6_8_pi_3": r"$12(\eta(x)-\sin(x_2))$",
    "experiment_1_6_9_mu": r"$\eta(x)$",
    "experiment_1_6_9_pi_1": r"$\sin(x_2)+4(\eta(x)-\sin(x_2))$",
    "experiment_1_6_9_pi_2": r"$\sin(x_2)+8(\eta(x)-\sin(x_2))$",
    "experiment_1_6_9_pi_3": r"$\sin(x_2)+12(\eta(x)-\sin(x_2))$",
    "experiment_1_6_11_mu": r"$\eta(x)$",
    ...
    "experiment_1_6_13_mu": r"$\eta(x)$",
    "experiment_1_6_13_pi_1": r"$\sin(x_2)+\sin(5x_2)+0.05\sin(20x_2)$",
    "experiment_1_6_13_pi_2": r"$\sin(x_2)+2\sin(5x_2)+0.05\sin(20x_2)$",
    "experiment_1_6_13_pi_3": r"$\sin(x_2)+3\sin(5x_2)+0.05\sin(20x_2)$",
    "experiment_1_6_14_mu": r"$\mu(x)$",
    "experiment_1_6_14_pi_1": r"$\cos(x_1)+0.5\sin(6x_2)+0.05\sin(19x_3)$",
    "experiment_1_6_14_pi_2": r"$\cos(x_1)+\sin(6x_2)+0.05\sin(19x_3)$",
    "experiment_1_6_14_pi_4": r"$\cos(x_1)+2\sin(6x_2)+0.05\sin(19x_3)$",
    ...
    "experiment_1_7_2_mu": r"$g_1(q^\top x)$",
    "experiment_1_7_2_pi_1": r"$g_1(q^\top x)$",
    "experiment_1_7_2_pi_2": r"$g_2(q^\top x)$",
    "experiment_1_7_2_pi_4": r"$g_4(q^\top x)$",
    "experiment_1_7_2_pi_8": r"$g_8(q^\top x)$",
    "experiment_1_7_3_mu": r"$g_1(x_1)$",
    "experiment_1_7_3_pi_1": r"$g_1(x_1)$",
    "experiment_1_7_3_pi_2": r"$g_2(x_1)$",
    "experiment_1_7_3_pi_4": r"$g_4(x_1)$",
    "experiment_1_7_3_pi_8": r"$g_8(x_1)$",
    "experiment_1_7_4_mu": r"$\tilde g_1(x_1)$",
    "experiment_1_7_4_pi_1": r"$\tilde g_1(x_1)$",
    ...
    "experiment_1_7_8_mu": r"$f_{0.6}(w^\top x)$",
    ...
    "experiment_1_7_9_mu": r"$f_{0.6}(w^\top x)$",
    "experiment_1_7_9_pi_1": r"$f_1(w^\top x)$",
    "experiment_1_7_9_pi_2": r"$f_2(w^\top x)$",
    "experiment_1_7_9_pi_4": r"$f_4(w^\top x)$",
    "experiment_1_7_9_pi_8": r"$f_8(w^\top x)$",
}
...
def plm_uniform_noise_dgp_generator(param_config: dict, seed: int | None = None) -> PartialLinearModelUniformNoiseDGP:
    ...
    if "beta" in param_config:
    ...
    elif param_config.get("beta_sampler_name") == "balanced_discrete":
        raw_beta_values = param_config["beta_values"]
        ...
        if seed is None:
            ...
            beta = beta_values[int(seed) % len(beta_values)]
    else:
...
def build_experiment_1_6_2(
    ...
    """Build the aligned one-coordinate amplitude family requested for experiment 1.6.2."""
    unit_variance_scale = math.sqrt(3.0)
    dgp_param_grid = {
        "d": 2,
        "func_mu_name": "experiment_1_6_2_mu",
        "func_pi_name": [
...
def build_experiment_1_6_3(
    ...
    """Build the two-coordinate sine-amplitude family requested for experiment 1.6.3."""
    unit_variance_scale = math.sqrt(3.0)
    dgp_param_grid = {
        "d": 2,
        "func_mu_name": "experiment_1_6_3_mu",
        "func_pi_name": [
...
def build_experiment_1_6_4(
    ...
    """Build the same-coordinate sine-amplitude family requested for experiment 1.6.4."""
    unit_variance_scale = math.sqrt(3.0)
    dgp_param_grid = {
        "d": 2,
        "func_mu_name": "experiment_1_6_4_mu",
        "func_pi_name": [
...
def build_experiment_1_6_5(
    ...
    """Build the rough-only sine-amplitude family requested for experiment 1.6.5."""
    unit_variance_scale = math.sqrt(3.0)
    dgp_param_grid = {
        "d": 2,
        "func_mu_name": "experiment_1_6_5_mu",
        "func_pi_name": [
...
def build_experiment_1_6_7(
    ...
    """Build the eta-scaled treatment family requested for experiment 1.6.7."""
    unit_variance_scale = math.sqrt(3.0)
    dgp_param_grid = {
        "d": 2,
        "func_mu_name": "experiment_1_6_7_mu",
        "func_pi_name": [
...
def build_experiment_1_6_8(
    ...
    """Build the eta-residual treatment family requested for experiment 1.6.8."""
    unit_variance_scale = math.sqrt(3.0)
    dgp_param_grid = {
        "d": 2,
...
def build_experiment_1_6_9(
    ...
    """Build the eta-plus-residual treatment family requested for experiment 1.6.9."""
    unit_variance_scale = math.sqrt(3.0)
    dgp_param_grid = {
        "d": 2,
        "func_mu_name": "experiment_1_6_9_mu",
        "func_pi_name": [
...
def build_experiment_1_6_11(
    ...
    """Build the ten-dimensional residual-only eta treatment family."""
    unit_variance_scale = math.sqrt(3.0)
    dgp_param_grid = {
        "d": 10,
        "func_mu_name": "experiment_1_6_11_mu",
        "func_pi_name": [
...
def build_experiment_1_6_13(
    ...
    """Build the two-dimensional shifted-amplitude treatment family."""
    unit_variance_scale = math.sqrt(3.0)
    dgp_param_grid = {
        "d": 2,
...
def build_experiment_1_6_14(
    ...
    """Build the three-dimensional cosine/sine treatment family."""
    unit_variance_scale = math.sqrt(3.0)
    dgp_param_grid = {
        "d": 3,
        "func_mu_name": "experiment_1_6_14_mu",
        "func_pi_name": [
...
def build_experiment_1_6_14_tracking(
    exp_id: str,
    n_trials: int,
    seed_offset: int = 0,
    device: str = "cpu",
    ...
    """Build the validation nuisance tracking diagnostic for 1.6.14."""
    unit_variance_scale = math.sqrt(3.0)
    dgp_param_grid = {
        "d": 3,
        "func_mu_name": "experiment_1_6_14_mu",
...
def build_experiment_1_7_2(
    ...
    """Build the fixed-coefficient projected Fourier family for PLM experiment 1.7.2."""
    unit_variance_scale = math.sqrt(3.0)
    dgp_param_grid = {
        "d": PLM_172_DIMENSION,
        "func_mu_name": "experiment_1_7_2_mu",
        "func_pi_name": [
...
def build_experiment_1_7_3(
    ...
    """Build the fixed-coefficient first-coordinate Fourier family for PLM experiment 1.7.3."""
    unit_variance_scale = math.sqrt(3.0)
    dgp_param_grid = {
        "d": PLM_173_DIMENSION,
        "func_mu_name": "experiment_1_7_3_mu",
        "func_pi_name": [
...
def build_experiment_1_7_4(
    ...
    """Build the first-coordinate Fourier family with alternating cosine signs for PLM experiment 1.7.4."""
    unit_variance_scale = math.sqrt(3.0)
    dgp_param_grid = {
        "d": PLM_174_DIMENSION,
        "func_mu_name": "experiment_1_7_4_mu",
        "func_pi_name": [
...
def build_experiment_1_7_5_tracking(
    exp_id: str,
    n_trials: int,
    seed_offset: int = 0,
    device: str = "cpu",
    ...
    """Build the validation nuisance tracking diagnostic for 1.7.5."""
    unit_variance_scale = math.sqrt(3.0)
    dgp_param_grid = {
        "d": PLM_175_DIMENSION,
        "func_mu_name": "experiment_1_7_5_mu",
...
def build_experiment_1_7_8(
    ...
    """Build the projected tanh-wrapped family for PLM experiment 1.7.8."""
    unit_variance_scale = math.sqrt(3.0)
    dgp_param_grid = {
        "d": PLM_175_DIMENSION,
        "func_mu_name": "experiment_1_7_8_mu",
        "func_pi_name": [
            "experiment_1_7_5_pi_1",
            "experiment_1_7_5_pi_2",
            "experiment_1_7_5_pi_4",
...
def build_experiment_1_7_8_tracking(
    exp_id: str,
    n_trials: int,
    seed_offset: int = 0,
    device: str = "cpu",
    ...
    """Build the validation nuisance tracking diagnostic for 1.7.8."""
    unit_variance_scale = math.sqrt(3.0)
    dgp_param_grid = {
        "d": PLM_175_DIMENSION,
        "func_mu_name": "experiment_1_7_8_mu",
...
def build_experiment_1_7_8_minimax(
    exp_id: str,
    n_trials: int,
    seed_offset: int = 0,
    device: str = "cpu",
    ...
    """Build the minimax ablation diagnostic for the 1.7.8 family."""
    unit_variance_scale = math.sqrt(3.0)
    dgp_param_grid = {
        "d": PLM_175_DIMENSION,
        "func_mu_name": "experiment_1_7_8_mu",
...
def build_experiment_1_7_9(
    ...
    """Build the five-dimensional projected tanh-wrapped family for PLM experiment 1.7.9."""
    unit_variance_scale = math.sqrt(3.0)
    dgp_param_grid = {
        "d": PLM_179_DIMENSION,
        "func_mu_name": "experiment_1_7_9_mu",
        "func_pi_name": [
            "experiment_1_7_9_pi_1",
            "experiment_1_7_9_pi_2",
            "experiment_1_7_9_pi_4",
            "experiment_1_7_9_pi_8",
        ],
        "beta_sampler_name": "uniform",
        "beta_low": -0.5,
        "beta_high": 0.5,
...
def build_experiment_1_7_9_tracking(
    exp_id: str,
    n_trials: int,
    seed_offset: int = 0,
    device: str = "cpu",
    ...
    """Build the validation nuisance tracking diagnostic for 1.7.9."""
    unit_variance_scale = math.sqrt(3.0)
    dgp_param_grid = {
        "d": PLM_179_DIMENSION,
        "func_mu_name": "experiment_1_7_9_mu",
...
def build_experiment_1_7_9_minimax(
    exp_id: str,
    n_trials: int,
    seed_offset: int = 0,
    device: str = "cpu",
    ...
    """Build the minimax ablation diagnostic for the 1.7.9 family."""
    unit_variance_scale = math.sqrt(3.0)
    dgp_param_grid = {
        "d": PLM_179_DIMENSION,
        "func_mu_name": "experiment_1_7_9_mu",
...
EXPERIMENT_ID_BUILDERS = {
    ...
    "1.7_8": build_experiment_1_7_8,
    "1.7_8_tracking": build_experiment_1_7_8_tracking,
    "1.7_8_minimax": build_experiment_1_7_8_minimax,
